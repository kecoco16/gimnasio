      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-3">
            ...
            $cantidad = count($data);
            for($i=0; $i<$cantidad; $i++){
              echo "<img class='img-responsive img-rounded' src='imagenes/".$data[$i]["ruta_imagen"]."'>";
            }
            ?>
          </div>
          <div class="col-md-8">
              ...
              for($i=0; $i<$cantidad; $i++){
                ...
                <tr>
                  <td style= 'text-aling:center;'>
                    ...
                    <a title='Realizar pago' data-toggle='tooltip' data-placement='bottom' href='pago.php? id=".$data[$i]["id_clientes"]."'><i style='padding-top:16px; ' class='fa fa-credit-card-alt fa-3x'></i></a>
                    <a title='Editar' data-toggle='tooltip' data-placement='bottom' href='editar.php? id=".$data[$i]["id_clientes"]."'><i style='padding-left:15px;' class='fa fa-pencil fa-3x'></i></a>
                    <a title='Eliminar' data-toggle='tooltip' data-placement='bottom' href='eliminar.php? id=".$data[$i]["id_clientes"]."'><i style='padding-left:15px;' class='fa fa-trash fa-3x'></i></a>
                  </td>
                </tr>
                ";
              }
