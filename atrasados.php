    ...
    <div class="panel panel-success">
      <div class="panel-heading">
        <h3 class="panel-title">Total de clientes <?php echo count($datatotal); ?>
          <a title='Generar PDF' data-toggle='tooltip' data-placement='bottom' style="margin-right: 15px;" class="navbar-right" href="pdf/pdfatrasados.php" target="_blank"><i class="fa fa-file-pdf-o"></i></a>   
        </h3>
      </div>
