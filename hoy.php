...
<body>
  ...
  <div class="box-principal">
    <h3 class="titulo"><br><br>Clientes para hoy<hr></h3>
    ...
    <div class="panel panel-success">
      <div class="panel-heading">
        <h3 class="panel-title">Total de clientes <?php $cantidad = count($datatotal); echo $cantidad; ?>
          <a title='Generar PDF' data-toggle='tooltip' data-placement='bottom' style="margin-right: 15px;" class="navbar-right" href="pdf/pdfhoy.php" target="_blank"><i class="fa fa-file-pdf-o"></i></a>   
        </h3>
      </div>
    ...
    if ($cantidadtotal > $cantidad_resultados_por_pagina ) {
      ...
      <ul class="pagination navbar-right">
        <li><a href="hoy.php">&laquo;</a></li>
        <?php 
        for ($i=1; $i <=$total_paginas ; $i++) { 
          echo "<li><a href='?pagina=".$i."'>" .$i."</a></li>  ";
        }
        ?>
        <li><a href=<?php echo "hoy.php?pagina=".$total_paginas;  ?>>&raquo;</a></li>
      </ul> 
      <?php 
    }
    ?>
